...
<link href="https://fonts.googleapis.com/css2?family=Arimo&display=swap" rel="stylesheet">
    ...
    <div id="menu" class="sidemenu">
        ...
        <a href="ytupload.php" id="link3" class="tsb  c1 fon3">Trailer</a>
...
<div class="container ct mt-5">
    <div class="col-sm-2 pt-1">
        <img src="../style_sheets/pictures/logo.png" width="100%">
    </div>
    <div class="idtxt text-center pl-5 pr-5 c9 fon1">
        Update Trailers
    </div>
    
        <div align="center" class="pt-3">
            <div class="col-sm-2">
                <button type="button" name="add" id="add" class="btn mb-3 but btn-block btn-success" target="#myModal">Insert</button>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        <form id="linkform" method="post" enctype="multipart/form-data" class="pt-5" style="height: 100vh ;">
                            ...
                            <div class="form-group ">
                                <label>Link</label>
                                <input type="text" name="links" class="form-control" id="links" placeholder="Add link">
                            </div>
